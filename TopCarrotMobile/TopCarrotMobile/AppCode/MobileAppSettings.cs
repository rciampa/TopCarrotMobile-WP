...
{
    public partial class MobileAppSettings : Application
    {
        ...
        /// <summary>
        /// Adds the Key and proerty Value to the current application. This settings are accessable via
        /// App.Current.Resourses and are not persistant accross different instances of the application
        /// </summary>
        /// <param name="Key">The key name for the settings property</param>
        /// <param name="value">The value of the key to be set</param>
        void AddOrUpdateAppCurrent(string Key, Object value)
        {
            //Check to see if the key exist
            if (Current.Resources.Contains(Key))
            {
                //Check to see if the value is current
                if (!Current.Resources[Key].Equals(value))
                {
            ...
            {
                //Add the key and the current value
        ...
        public string PushChannelUri
        {
            get
            {
                return GetValueOrDefault<string>(PushChannelUriKeyName, PushChannelUriDefault);
            }
            set
            {
                if (AddOrUpdateValue(PushChannelUriKeyName, value))
                {
                    Save();
                }
            }
        ...
        /// <summary>
        /// Keeps the state of the push channel from the channel changed event.
        /// </summary>
        public bool IsPushChannelConneted
        {
            get
            {
                return GetValueOrDefault<bool>(IsPushChannelConnectedKeyName, IsPushChannelConnectedDefault);
            }
            set
            {
                if(AddOrUpdateValue(IsPushChannelConnectedKeyName,value))
                {
                    Save();
                }
            }
